...
namespace FormsUI
{
    public partial class FormGameSettings : Form
    {
        ...
        private void buttonPlayAgainstComputerClicked(object sender, EventArgs e)
        {
            m_IsAgainstComputer = true;
            startNewGame();
        }
        private void buttonBoardSizeClicked(object sender, EventArgs e)
        {
            changeBoardSize();
        ...
        private void buttonPlayAgainstFriendClicked(object sender, EventArgs e)
        {
            startNewGame();
        }
